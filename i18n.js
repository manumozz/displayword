/* ================================================================
   ...
   Edition names: Church (Free) · Connect ($29) · Team ($59)
   ================================================================ */
...
const DW_T = {
  en: {
    ...
    home_p:     "Control your church's screens from multiple devices simultaneously — worship leader's tablet, speaker's tablet, and the operator's computer. Display lyrics, chords, Bible verses, media, and messages on screens.",
    ...
    home_feat_title: "Everything your operator needs",
    home_feat_sub:   "Built around how worship services actually run — not how software companies think they do.",
    f1_title: "Three Screens at Once",
    f1_p:     "Independently control the Hall, Stage, and Preacher displays from a single operator console. Each screen shows exactly what it should.",
    f2_title: "Lyrics + Chords",
    f2_p:     "Show clean lyrics to the congregation while musicians see chords in their key — with one-click transposition to any key on the fly.",
    f3_title: "Special Cues for Musicians",
    f3_p:     "Send instant signals to the stage screen: A Cappella, Drums Only, Repeat, Slower — as brief banners the hall never sees.",
    f4_title: "Works with Any Equipment",
    f4_p:     "One PC and one projector? That's enough. In the Team edition, musicians use their phones as stage screens over Wi-Fi.",
    f5_title: "Song Library",
    f5_p:     "Organize all your congregation's songs with full editing, verse ordering, and key detection. Build a setlist in under 5 minutes.",
    f6_title: "Works Offline",
    f6_p:     "No internet required during services. Everything runs locally on your PC. Reliable when you need it most.",
    ...
    who1_title: "House Churches",     who1_p: "One laptop, one TV. Musicians use their phones. Simple and free.",
    ...
    cta_p:        "Be first to know when the pilot release drops. Free for all early churches.",
    ...
    f_med_desc:  "Add photo and video backgrounds to your slides. Manage a media library, show announcements, or display Bible verses — all from the same operator console.",
    f_med_l1: "Photo and video backgrounds for any slide",
    f_med_l2: "Background library with instant preview",
    f_med_l3: "Quick messages to any screen (announcements, alerts)",
    f_med_l4: "Message history for one-click resend",
    f_med_l5: "Light and dark theme for the operator console",
    ...
    church_d4:  "Media &amp; video backgrounds",

    connect_always: "One-time payment · lifetime updates",
    ...
    connect_pf6: "Media tab: photos &amp; video backgrounds",
    connect_pf7: "Print chord sheets as PDF",
    connect_d1:  "Wi-Fi web screens for phones/tablets",

    team_always: "One-time payment · lifetime updates",
    ...
    cmp_media:       "Media",
    cmp_photo:       "Photo backgrounds",
    cmp_video:       "Video backgrounds",
    ...
    v1_l7:  "Media tab with photo &amp; video backgrounds",
  ...
  ru: {
    ...
    home_feat_title: "Всё что нужно оператору",
    home_feat_sub:   "Создано под реальный формат богослужения — не так, как это видят разработчики.",
    f1_title: "Три экрана одновременно",
    f1_p:     "Управляйте экранами Зала, Сцены и Проповедника с единого пульта. Каждый экран показывает именно то, что должен.",
    f2_title: "Тексты + Аккорды",
    f2_p:     "Прихожане видят чистый текст, музыканты — аккорды в своей тональности. Транспонирование одним кликом прямо во время служения.",
    f3_title: "Спецсигналы для музыкантов",
    f3_p:     "Мгновенные сигналы на экран сцены: А Капелла, Только барабаны, Повтор, Медленнее — краткие баннеры, которые зал не видит.",
    f4_title: "Работает с любым оборудованием",
    f4_p:     "Один ПК и один проектор? Этого достаточно. В версии Team музыканты используют свои телефоны как экраны сцены через Wi-Fi.",
    f5_title: "Библиотека песен",
    f5_p:     "Организуйте все песни общины с полным редактированием, порядком куплетов и тональностью. Сет-лист за 5 минут.",
    f6_title: "Работает без интернета",
    f6_p:     "Интернет не нужен во время служения. Всё работает локально на вашем ПК. Надёжно тогда, когда это важно.",
    ...
    who1_title: "Домашние церкви",       who1_p: "Один ноутбук, один телевизор. Музыканты используют телефоны. Просто и бесплатно.",
    ...
    cta_p:        "Узнайте первыми о выходе пилотного релиза. Бесплатно для первых церквей.",
    ...
    f_med_desc:  "Добавляйте фото и видеофоны к слайдам. Управляйте медиатекой, показывайте объявления или библейские стихи — всё с одного пульта.",
    f_med_l1: "Фото и видеофоны для любого слайда",
    f_med_l2: "Библиотека фонов с мгновенным предпросмотром",
    f_med_l3: "Быстрые сообщения на любой экран (объявления, оповещения)",
    f_med_l4: "История сообщений для повторной отправки одним кликом",
    f_med_l5: "Светлая и тёмная темы для пульта оператора",
    ...
    church_d4:  "Медиа и видеофоны",

    connect_always: "Разовый платёж · обновления навсегда",
    ...
    connect_pf6: "Медиа: фото и видеофоны",
    connect_pf7: "Печать аккордов в PDF",
    connect_d1:  "Веб-экраны для телефонов через Wi-Fi",

    team_always: "Разовый платёж · обновления навсегда",
    ...
    v1_l7:  "Вкладка медиа с фото и видеофонами",

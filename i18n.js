...
const DW_T = {
  en: {
    ...
    f_sc_label: "Three Screens",
    f_sc_title: "One operator.<br />Three independent displays.",
    f_sc_desc:  "The Hall, Stage, and Preacher screens each show exactly what they should — simultaneously. Your congregation sees clean lyrics. Musicians see chords. The preacher sees what's coming next.",
    f_sc_l1: "Hall screen: lyrics for the congregation",
    f_sc_l2: "Stage screen: chords, musician cues, key info",
    f_sc_l3: "Preacher screen: coming slide, verse reference",
    f_sc_l4: "Blackout button — removes all screens instantly",
  ...
  ru: {
    ...
    home_h1:    "Ваше богослужение,<br /><span class=\"text-gold\">красиво на экранах</span>",
    ...
    f_sc_label: "Три экрана",
    f_sc_title: "Один оператор.<br />Три независимых экрана.",
    f_sc_desc:  "Экраны Зала, Сцены и Проповедника показывают именно то, что нужно — одновременно. Прихожане видят чистый текст. Музыканты — аккорды. Проповедник — что идёт следующим.",
    f_sc_l1: "Экран зала: тексты для прихожан",
    f_sc_l2: "Экран сцены: аккорды, сигналы, тональность",
    f_sc_l3: "Экран проповедника: следующий слайд, стих",
    f_sc_l4: "Кнопка затемнения — скрывает все экраны мгновенно",
